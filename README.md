...
**Switching is a gesture Debut draws itself.** macOS offers no supported way to change
desktop on demand, so Debut forges the trackpad swipe — a technique from
