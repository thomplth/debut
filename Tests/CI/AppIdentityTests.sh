...
# Remote analytics configuration must not return to the distributable bundle.
expect_not_contains "Resources/Info.plist" 'TelemetryDeck|Analytics|Telemetry' \
    "Info.plist must not configure a remote analytics service"
