...
See [CONTRIBUTING.md](CONTRIBUTING.md) for setup, verification, and pull requests.
Keep changes scoped, and do not publish releases or change signing credentials as
...
- Keep [settings](spec/settings.md) aligned with fresh defaults while preserving
  saved choices.
